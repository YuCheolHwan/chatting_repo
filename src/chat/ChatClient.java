...
public class ChatClient {
	...
	public static final String IP_SERVER = "172.30.1.123";
	public static final int PORT_SERVER = 7878;
	...
	public static void main(String[] args) {
		...
		try {
			...
			scanner.close();
			// 3-1-2. 소켓을 통해 출력 보조 스트림을 가져온다.(서버가 PrintWriter로 쓰고, BufferedReader로 읽으므로 똑같이
			// 만듬)
			...
			/*
			 * 4. UI(AWT) 창에서 BufferedReader, PrintWriter 서버에게 요청하고 응답을 받고 무한루프 속에서 진행 UI창에서
			 * 죽지 않고 계속 떠서 4가지 업무를 진행한다.
			 */
